...
const translations = {
    zh: {
        ...
        'leisure-title': 'TIDEMASTER LEISURE',
        'leisure-desc': '豪华休闲游艇，为您打造完美的海上生活方式',
        'view-details': '查看详情',
    ...
    en: {
        ...
        'leisure-title': 'TIDEMASTER LEISURE',
        'leisure-desc': 'Luxury leisure yacht for perfect marine lifestyle',
